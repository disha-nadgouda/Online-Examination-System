<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/TeacherMaster.Master" AutoEventWireup="true" CodeBehind="ExamList.aspx.cs" Inherits="Online_Test.Teacher.ExamList" %>
    ...
    <table class=""width="900" align="center" cellpadding="7" style="border: thin solid #000000">
        <tr>
            <td style="background-color: #FF3300">
                <asp:Button ID="Button5" runat="server" BackColor="Red" BorderStyle="None" CssClass="auto-style5" ForeColor="White" Text="Exam List" Width="510px" Height="40px" PostBackUrl="~/Teacher/ExamList.aspx" />
            </td>
            <td style="background-color: #000000">
                <asp:Button ID="Button6" runat="server" BackColor="Black" BorderStyle="None" CssClass="auto-style5" ForeColor="White" Text="Add Exam" Width="510px" Height="40px" PostBackUrl="~/Teacher/AddExam.aspx" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
