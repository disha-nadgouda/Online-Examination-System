<%@ Page Title="" Language="C#" MasterPageFile="~/Student/StudentMaster.Master" AutoEventWireup="true" CodeBehind="Online Test.aspx.cs" Inherits="Online_Test.Student.Online_Test" %>
        ...
        <tr>
            ...
            <td>
                <asp:DataList ID="DataList4" runat="server" DataSourceID="SqlDataSource5" RepeatDirection="Horizontal" CellPadding="10" RepeatColumns="5">
                    <ItemTemplate>
                        <asp:Button ID="Button6" runat="server" Text='<%# Eval("sem") %>' BackColor="#009999" BorderStyle="None" CommandArgument='<%# Eval("sem") %>' Font-Bold="True" ForeColor="White" Height="40px" Width="200px"  style="border-radius:20px;" OnClick="Button6_Click"  />
                    </ItemTemplate>
                </asp:DataList>
        ...
        <tr>
            ...
            <td>
                <asp:DataList ID="DataList3" runat="server" DataSourceID="SqlDataSource3" RepeatDirection="Horizontal" CellPadding="10" RepeatColumns="5">
                    <ItemTemplate>
                        <asp:Button ID="Button5" runat="server" Text='<%# Eval("examsubject") %>' BackColor="#009999" BorderStyle="None" CommandArgument='<%# Eval("examsubject") %>' Font-Bold="True" ForeColor="White" Height="40px" Width="200px"  style="border-radius:20px;" OnClick="Button5_Click" />
                    </ItemTemplate>
                </asp:DataList>
