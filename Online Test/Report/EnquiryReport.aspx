<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EnquiryReport.aspx.cs" Inherits="Online_Test.Report.EnquiryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table align="center" cellpadding="4" class="auto-style1">
        <tr>
            <td class="auto-style10"><strong>Enquiry Report</strong></td>
        </tr>
        <tr>
            <td>
