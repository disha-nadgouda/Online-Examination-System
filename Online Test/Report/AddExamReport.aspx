<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddExamReport.aspx.cs" Inherits="Online_Test.Report.AddExamReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table align="center" cellpadding="4" class="auto-style1">
        <tr>
            <td class="auto-style10"><strong>Add Exam Report</strong></td>
        </tr>
        <tr>
            <td>
